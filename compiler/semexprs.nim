...
proc semConstrFields(c: PContext, recNode: PNode,
  ...
  of nkRecList:
    for field in recNode:
      let status = semConstrFields(c, field, initExpr, flags)
  ...
  of nkRecCase:
    ...
    for i in 1 .. <recNode.len:
      ...
      let status = semConstrFields(c, innerRecords, initExpr, flags)
...
proc semContuctType(c: PContext, t: PType,
                    initExpr: PNode, flags: TExprFlags): InitStatus =
  var t = t
  result = initUnknown
